...
export const InspirationPage: React.FC = () => {
    ...
    return (
        ...
        >
            <div className="h-full w-full p-8 overflow-y-auto flex flex-col justify-center items-center text-center">
                
                <div className="bg-black/40 backdrop-blur-xl rounded-2xl p-8 border border-white/20 w-full max-w-3xl">
