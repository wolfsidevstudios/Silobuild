    ...
    <div className="bg-white text-gray-800 min-h-screen font-sans">
      ...
      <main className="container mx-auto px-6 py-12 max-w-4xl">
        ...
        <div className="prose prose-lg text-gray-700 space-y-4">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 pt-4">1. Information Collection and Use</h2>
            ...
            <h2 className="text-2xl font-semibold text-gray-900 pt-4">2. Use of Data</h2>
            ...
            <h2 className="text-2xl font-semibold text-gray-900 pt-4">3. Data Storage</h2>
            ...
            <h2 className="text-2xl font-semibold text-gray-900 pt-4">4. Service Providers</h2>
            ...
            <h2 className="text-2xl font-semibold text-gray-900 pt-4">5. Security of Data</h2>
            <p>The security of your data is important to us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While we strive to use commercially acceptable means to protect your Personal Data, we cannot guarantee its absolute security.</p>
            
            <h2 className="text-2xl font-semibold text-gray-900 pt-4">6. Changes to This Privacy Policy</h2>
            <p>We may update our Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on this page.</p>
            
            <h2 className="text-2xl font-semibold text-gray-900 pt-4">Contact Us</h2>
            <p>If you have any questions about this Privacy Policy, please contact us.</p>
            <p className="pt-6 font-bold text-red-600">Disclaimer: This is a template Privacy Policy. You should consult with a legal professional to ensure it meets your specific needs.</p>
        </div>
      </main>
    </div>
  );
