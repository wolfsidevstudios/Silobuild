...
import { PlusIcon, TrashIcon, DatabaseIcon, FileIcon, SparklesIcon } from '../components/icons';
...
export const DatabasePage: React.FC = () => {
    ...
    <div className="p-8">
      ...
      <p className="text-gray-600 mb-8 max-w-3xl">
        Visually design your database schema. Add tables, define columns and constraints, and then generate the SQL script to create them. This database is local to your project and does not use Supabase.
      </p>
