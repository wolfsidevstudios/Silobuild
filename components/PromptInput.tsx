  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 p-4 flex justify-center z-10">
      ...
      >
        <button
          type="button"
          className="bg-white text-gray-900 rounded-full px-4 py-2 flex items-center gap-2 text-sm font-semibold flex-shrink-0 hover:bg-gray-200 transition-colors"
        >
