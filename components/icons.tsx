...
export const VueIcon = ({ className = "w-8 h-8" }) => (
    <svg className={className} viewBox="0 0 256 221" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
...
export const SvelteIcon = ({ className = "w-8 h-8" }) => (
     <svg className={className} viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg">
        <g fill="#FF3E00">
            <path d="m250 20c-132.85 0-240 107.15-240 240s107.15 240 240 240 240-107.15 240-240-107.15-240-240-240zm119.34 115.39c-14.3-13.3-32.32-21.8-51.4-21.8-19.14 0-38.33 9.4-50.05 24.3-15.3 19.3-22.31 43.3-21.36 65.4.15 3.5.45 7.1.88 10.6 2.01 16.3 8.32 32.8 19.31 46.1 14.8 17.9 35.5 28.5 56.4 28.5 23.33 0 46.5-12.8 58.9-35.3 11.2-20.3 13.9-44.5 7.8-66.2-2.1-7.6-5.4-15-9.8-21.5zm-225.29 285.81c-6.1-3.1-11.8-6.9-16.9-11.2-34.4-28.7-52.4-71.9-52.4-114.6 0-20.2 4.4-40.4 13.2-58.8 11.1-23.2 28.9-42 50.1-53.7 2.1-1.2 4.3-2.3 6.6-3.3 13.8-6.3 28.8-9.6 43.8-9.6 15.6 0 31.6 3.6 46.4 10.4 19.9 9.2 36.8 24.6 48.7 43.8 12.3 19.9 19.1 43.2 19.1 66.5 0 23.3-6.8 46.6-19.1 66.5-11.8 19-28.3 34.2-47.8 43.6-15 7.1-31.2 10.8-47.3 10.8-15.8 0-31.8-3.7-46.6-10.7-2.3-.9-4.5-2-6.6-3.1z"/>
            <path d="m142.14 178.69c-2.8 11.2-3.8 22.9-2.9 34.4.9 12.7 4.1 25.5 9.8 37.4 8.7 18.2 23.5 33.5 41.5 43.1 1.4.7 2.8 1.4 4.2 2.1 6.5 2.8 13.3 4.9 20.3 6.2 1.8.3 3.6.6 5.4.8h.4c3.5-.1 7.1-.6 10.6-1.5 16.3-4 32.2-12.2 44.8-23.7 16.9-15.5 28-36.8 31.6-58.9 1-6.1 1.5-12.3 1.5-18.4 0-7.3-.8-14.7-2.4-21.9-2.3-10.1-6.1-20-11.4-29.2-1.2-2.1-2.5-4.1-3.8-6.1-14.2-21.2-36-35.8-59.5-41-1.3-.3-2.6-.6-3.9-.9-7.2-1.7-14.5-2.2-21.7-1.5-11.7 1.2-23.5 5-34 11.5-1.9 1.2-3.7 2.4-5.5 3.7-17.7 12.5-31.1 30-38.8 49.3zm-28.9 96.9c-11.9-13.3-18.6-29.8-19.5-46.6-.1-2.3-.1-4.7-.1-7 0-19.4 5.3-39 15.7-56.1 14-23.1 36.5-39.7 61.6-46.1 6.9-1.8 14-2.7 21-2.7 14.3 0 28.9 4.1 42.1 11.9 21.6 12.8 37.8 33.7 45.4 57.4 2.9 8.9 4.4 18.2 4.4 27.5 0 15.8-4.7 31.8-14.1 45.7-12.8 18.8-31.5 32.1-52.1 37.5-6.8 1.8-13.8 2.6-20.7 2.6-13.9 0-28.1-4-41-11.5-22-12.7-38.5-33.1-45.3-57.5z"/>
        </g>
    </svg>
);
...
export const TemplateIcon = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
...
// FIX: Added DotsHorizontalIcon component to resolve import error in ProjectsPage.tsx
export const DotsHorizontalIcon = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const CubeTransparentIcon = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
